...
from mmdet3d.datasets.nuscenes_world_dataset import NuScenesWorldDataset
try:
...
def main():
    ...
    '''args.config为stage2.py文件'''
    '''cfg不是一个简单的字典，是一个mmcv.Config类，字典信息在_cfg_dict中，它还有一些function_variables,workflow等一系列信息'''
    ...
    if hasattr(cfg, "plugin"):
        if cfg.plugin:
            ...
            if hasattr(cfg, "plugin_dir"):
                ...
                '''这里都是在处理projects/mmdet3d_plugs的路径'''

                for m in _module_dir[1:]:
                    _module_path = _module_path + "." + m
                print(_module_path)
                '''projects.mmdet3d_plugs'''
    ...
    '''给meta放了两个信息：config与env_info，config中有网络结构信息'''
    ...
    '''meta还有seed==0, exp_name为config的py文件'''
