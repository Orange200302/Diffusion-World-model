...
class Collect3D(object):
    ...
    def __init__(
        ...
        meta_keys=('filename', 'ori_shape', 'img_shape',
                   'lidar2img', 'ego2img', 'ego2lidar', 'sensor2sensorego', 'sensorego2global', 'sensorego2sensor', 'global2sensorego', 'cam2img',
                   ...
                   'ego_to_global_translation', 'ego_from_sensor', 'lidar2ego_rotation', 'lidar2ego_translation', 'lidar2ego_rt', 'pose_mat', 'ego2global_translation', 'global2ego_rotation',
                    'lidar_to_ego_rotation', 'lidar_to_ego_translation', 'ego_to_lidar_rotation', 'global_to_ego_rotation', 'sample_weight', 'gt_bboxes_3d', 'gt_attr_labels', 'gt_ego_fut_trajs_ori',
                   'ego_to_lidar',
                   )
    ):
        self.keys = keys
